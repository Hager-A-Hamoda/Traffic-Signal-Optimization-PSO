...
class ExperimentRunner:
    ...
    def run_all(self, verbose: bool = True) -> list[dict]:
        self.experiments = []    # reset experiments list in case of multiple calls
        self.all_results = []
    ...
    def print_comparison(self):
        ...
        sorted_results = sorted(self.all_results, key=lambda r: r["avg_score"])   # sort by avg score (lower is better)
